...
interface ProjectCategoryMobileProps {
  cover: ProjectCover;
  getLabelFromPath: (path: string) => string;
}

const ProjectCategoryMobile = ({ cover, getLabelFromPath }: ProjectCategoryMobileProps) => {
  return (
    <div className={styles.subContainerCategory}>
      ...
      <div className={styles.center}>
        <h2 className={styles.title}>
          <span className={styles.titleMain}>{cover.titleFirstPart} mobile</span>
...
export default ProjectCategoryMobile;
