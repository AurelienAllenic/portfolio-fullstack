...
export const projects = [
    ...
    },
    {
        id: 2,
        image: Ascent,
        title: "Ascent : site vitrine à destination des milieux de l'architecture et du design réalisé en nextJs, totalement administrable par l'utilisateur",
        titleEn:'Ascent : showcase project for architects and designers in nextJs, fully manageable by the user',
        github: '',
