...
const GudLft = 'https://res.cloudinary.com/dwpbyyhoq/image/upload/coursejpg_mmfjex.webp'
...
export const openclassrooms1_cover = {
    title: 'Formation WEB',
    slug: 'formation-web',
    content: 'Suivie en 2021, cette formation aborde largement les bases du développement web. Des projets en HTML, CSS, SCSS, Js vanilla, ReactJs et nodeJs ont pu être réalisés.',
...
export const openclassrooms1 = [
    ...
    },
    {
        ...
        titleEn: 'Ohmyfood',
        descriptionEn: 'Gastronomic website created with HTML, CSS and SCSS',       github: 'https://github.com/AurelienAllenic/AurelienAllenic.github.io',
    ...
    },
    {
        ...
        titleEn: 'Lapanthere',
        descriptionEn: 'Web design website based in Lyon, SEO improvement project for an existing site',
    ...
    },
    {
        ...
        image: Piiquante,
        title: 'Hot-takes',
        description: 'API de like et partage de sauces pimentées réalisée en Node.js et JavaScript',
        titleEn: 'Hot-takes',
        descriptionEn: 'API for liking and sharing spicy sauces created with Node.js and JavaScript',
...
export const openclassrooms2 = [
    ...
    },
    {
        ...
        image: Fisheye,
        title: 'Fisheye',
        description: 'Site accessible pour une plateforme de photographes en JavaScript',
        titleEn: 'Fisheye',
        descriptionEn: 'Accessible website for a photographer platform created in JavaScript',
    ...
    },
    {
        ...
        image: LearnHome,
        title: 'LearnHome',
        description: "Projet de maquettage via Figma, de création de user stories et de diagrammes de cas d'usages",
        titleEn: 'LearnHome',
        descriptionEn: 'Figma mockup project, creation of user stories and use case diagrams',
        github: '',
        demo: '',
    ...
    },
    {
        ...
        descriptionEn: 'Refactoring in React.js from jQuery code of an employee management website using React Redux',
    ...
    },
    {
        ...
        image: Sportsee,
        title: 'Sportsee',
        description: 'Site FullStack React.js + Node.js permettant de suivre des statistiques sportives quotidiennes via des graphiques Recharts',
        titleEn: 'Sportsee',
        descriptionEn: 'FullStack React.js + Node.js website allowing to track daily sports statistics via Recharts graphs',
    ...
    },
    {
        ...
        image: ArgentBank,
        title: 'ArgentBank',
        description: "Site FullStack React.js + Node.js qui permet à l'utilisateur de se connecter à son compte bancaire et d'éditer son nom d'utilisateur",
        titleEn: 'ArgentBank',
        descriptionEn: 'FullStack React.js + Node.js website allowing users to connect to their bank account and edit their username',
...
export const openclassrooms3 = [
    ...
    },
    {
        ...
        titleEn: 'HomeSkolar',
        descriptionEn: 'Creation of a specifications document and product backlog for a school support association',
        github: '',
        demo: '',
        figma:'',
        folder: [
    ...
    },
    {
        ...
        titleEn: 'LitRevu',
        descriptionEn: 'Django project allowing users to post reviews or review requests and follow users',
    ...
    },
    {
        ...
        titleEn: 'SoftDesk',
        descriptionEn: 'Development of a RESTful API with Django Rest Framework to report and track technical issues in B2B',
    ...
    },
    {
        ...
        titleEn: 'GudLft',
        descriptionEn: 'Flask API testing project for seat reservations in sports competitions',
    ...
    },
    {
        ...
        titleEn: 'Epic Events',
        descriptionEn: 'Development of a secure backend with Python and SQL in the event industry',
    ...
    },
    {
        ...
        description: "Correction de bugs, testing, logging avec Sentry, documentation avec Read The Docs et Sphinx. Création d'un pipeline CI/CD avec GitHub Actions, Render et Docker",
        titleEn: 'Orange County Lettings',
        descriptionEn: 'Bug fixes, testing, logging with Sentry, documentation with Read The Docs and Sphinx. Creation of a CI/CD pipeline with GitHub Actions, Render and Docker',
...
export const projects = [
    {
        ...
        titleEn: 'paroxx.com',
        descriptionEn: 'Showcase website project for the artist ParoXX created with React.js / Vite',
        github: '',
    ...
    },
    {
        ...
        descriptionEn: 'Creation of a magic website for the public created in React.js',
        github: '',
    ...
    },
    {
        ...
        descriptionEn: 'This previous version of the website is created in Next.js and includes 3D models integrated via Three.js',
...
export const iim = [
    {
        ...
        descriptionEn: 'Car e-commerce website project in React.js allowing payment via Stripe',
    ...
    },
    {
        ...
        descriptionEn: 'ELT pipeline creation in Python with a MongoDB database and a dashboard via Metabase',
    ...
    },
    {
        ...
        titleEn: 'Mint',
        descriptionEn: 'Entrepreneurial and innovative project. Running race organization application, usable by organizations and runners, created as a team',
    ...
    },
    {
        ...
        descriptionEn: 'Basic e-commerce website project with Flutter, product storage in MongoDB and payments via Stripe',
    ...
    },
    {
        ...
        titleEn: 'AI Mnist',
        descriptionEn: 'Handwritten digit recognition project using AI with TensorFlow and Keras',
    ...
    },
    {
        ...
        descriptionEn: 'Basic e-commerce website project with Symfony, product storage in MongoDB and payments via Stripe',
