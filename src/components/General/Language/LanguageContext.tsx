...
const translations: Record<Language, Record<string, string>> = {
  fr: {
    ...
    "projects.category.ascent": "Projet Ascent",
    "projects.category.ascent.description": "Site vitrine à destination des milieux de l'architecture et du design réalisé en Next.js, totalement administrable par l'utilisateur",
    "projects.category.paro": "Projet Paro",
    "projects.category.paro.description": "Projet de site vitrine pour l'artiste Paro réalisé avec React.js / Vite",
    "projects.category.claquettes": "Projet Claquettes",
  ...
  en: {
    ...
    "projects.category.ascent": "Project Ascent",
    "projects.category.ascent.description": "Showcase website for architecture and design professionals created in Next.js, fully manageable by the user",
    "projects.category.paro": "Project Paro",
    "projects.category.paro.description": "Showcase website project for the artist Paro created with React.js / Vite",
    "projects.category.claquettes": "Project Claquettes",
