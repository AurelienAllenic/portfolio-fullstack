...
const translations: Record<Language, Record<string, string>> = {
  fr: {
    ...
    "contact.form.consent": "En envoyant ce message, je consens à être recontacté via l'adresse email fournie",
  ...
  en: {
    ...
    "contact.form.consent": "By sending this message, I consent to be contacted via the provided email address",
