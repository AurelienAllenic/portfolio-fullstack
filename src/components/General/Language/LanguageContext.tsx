...
const translations: Record<Language, Record<string, string>> = {
  fr: {
    ...
    "projects.category.personnel.description": "Des projets personnels aux thématiques variées : un site de magicien avec formulaire de réservation, une application web avec backoffice complet dans le domaine de l'architecture et la précédente version de ce portfolio.",
    ...
    "projects.category.celeste": "Céleste Ragonneau",
    "projects.category.celeste.description": "Site vitrine de Céleste Ragonneau, avocate au barreau de Paris (droit pénal, droit de la famille, violences conjugales et protection de l'enfance), développé en Next.js et SCSS avec une base de données MongoDB. Le site présente ses domaines d'intervention, ses honoraires, des articles juridiques et des témoignages clients, et intègre un formulaire de contact. Le site est disponible en français et en anglais.",    "projects.category.paro": "Paro",
  ...
  en: {
    ...
    "projects.category.personnel.description": "Personal projects covering varied themes: a magician's website with a booking form, a web application with a complete backoffice in the architecture field and the previous version of this portfolio.",
